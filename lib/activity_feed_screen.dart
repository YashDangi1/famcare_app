                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('No family activity yet', style: TextStyle(fontSize: 18, color: Colors.grey[600], fontWeight: FontWeight.w500)),
                            const SizedBox(height: 8),
                            Text('Start logging health data to see it here', style: TextStyle(fontSize: 14, color: Colors.grey[400])),
                          ],
                        ),
                      ),
                    )
