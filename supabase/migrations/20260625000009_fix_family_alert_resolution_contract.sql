-- supabase/migrations/20260625000009_fix_family_alert_resolution_contract.sql
...
begin
  ...
  -- Only recipient (patient_user_id) or admin can resolve
  if auth.uid() != v_alert.patient_user_id and v_role != 'admin' then
